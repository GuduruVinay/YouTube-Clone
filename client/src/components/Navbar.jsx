            ...
            <div className='flex justify-between items-center p-2 md:pl-4.5 md:pr-4'>
                ...
                <div className='flex gap-2 md:gap-4'>
                    <div className='flex'>
                        ...
                        <button className='cursor-pointer md:py-1.5 md:pl-4 md:pr-4 hover:bg-[#f0f0f0] dark:hover:bg-[#3d3d3d] md:border md:border-[#d3d3d3] dark:border-[#303030] dark:bg-[#212121] p-2 rounded-4xl md:rounded-l-none md:rounded-r-4xl md:border-l-0'><Search /></button>
                    </div>
