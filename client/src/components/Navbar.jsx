...
function Navbar() {
    ...
    return (
        <div>
            ...
            <div className='flex justify-between items-center p-2 pl-4 pr-2 md:pl-6 md:pr-4 lg:pl-4 dark:bg-[#0F0F0F] dark:text-white'>
                ...
                <div className='flex gap-4'>
                    <div className='flex'>
                        ...
                        <button className='md:pt-1.5 md:pb-1.5 md:pl-4 md:pr-4 hover:bg-[#f0f0f0] dark:hover:bg-[#3d3d3d] md:border md:border-[#d3d3d3] dark:border-[#303030] dark:bg-[#212121] md:rounded-r-4xl md:border-l-0'><Search /></button>
                    </div>
                ...
                <div className='flex gap-2 md:gap-4'>
                    ...
                    <button className='flex gap-2 text-[#065fd4] hover:bg-[#def1ff] dark:text-white pt-1.5 pb-1.5 pl-2.5 pr-2.5 border border-[#e5e5e5] dark:border-[#303030] dark:hover:bg-[#303030] rounded-4xl'>
                        <CircleUserRound />
                        <span>Sign in</span>
                    </button>
                </div>
